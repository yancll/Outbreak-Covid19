...
transformed parameters {
 ...
 // -alpa_IFR_c*(Ct[1])
  // -alpa_IFR_CFR*CFR[1]
  IFR[1]=IFR0*2*inv_logit(-weekly_effect_IFR[1]-alpa_IFR_c*log(Ct[1]+1)-alpa_IFR_s*Total_V[1]-momento_IFRt[1]*momento1[1]-momento_IFRt[2]*momento2[1]-
  ...
  for (i in 2:n){
    ...
    if(momento4[i]==1){momento_dich=4;}
      ...
      if(momento1[i]==1){
        IFR[i]=IFR0*2*inv_logit(-weekly_effect_IFR[1] -alpa_IFR_c*log(Ctacum[i]-Rec[i]+1)-
      ...
      if(momento2[i]==1){
        IFR[i]=IFR0*2*inv_logit(-weekly_effect_IFR[2] -alpa_IFR_c*log(Ctacum[i]-Rec[i]+1)-
      momento_IFRt[1]*momento1[i]-momento_IFRt[2]*momento2[i]-momento_IFRt[3]*momento3[i]-
      momento_IFRt[4]*momento4[i]+dot_product(-alpa_IFR_j_M,Variantes[i,]));
      }
      if(momento3[i]==1){
        IFR[i]=IFR0*2*inv_logit(-weekly_effect_IFR[3] -alpa_IFR_c*log(Ctacum[i]-Rec[i]+1)-
      momento_IFRt[1]*momento1[i]-momento_IFRt[2]*momento2[i]-momento_IFRt[3]*momento3[i]-
      momento_IFRt[4]*momento4[i]+dot_product(-alpa_IFR_j_M,Variantes[i,]));
      }
      if(momento4[i]==1){
        IFR[i]=IFR0*2*inv_logit(-weekly_effect_IFR[4] -alpa_IFR_c*log(Ctacum[i]-Rec[i]+1)-
      momento_IFRt[1]*momento1[i]-momento_IFRt[2]*momento2[i]-momento_IFRt[3]*momento3[i]-
      momento_IFRt[4]*momento4[i]+dot_product(-alpa_IFR_j_M,Variantes[i,]));
      }
